jQuery(document).ready(function($) {
	...
	$('#select1').click(expandClick1);
	$('#select2').click(expandClick2);
	$('#select3').click(expandClick3);
	$('#select4').click(expandClick4);
